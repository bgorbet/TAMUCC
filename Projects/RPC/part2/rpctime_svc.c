...
add_prog_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	...
	case nullRemote1:
		...
		local = (char *(*)(char *, struct svc_req *)) nullremote1_1_svc;
		break;

	case nullRemote2:
		_xdr_argument = (xdrproc_t) xdr_int;
		_xdr_result = (xdrproc_t) xdr_int;
		local = (char *(*)(char *, struct svc_req *)) nullremote2_1_svc;
		break;

	case nullRemote3:
		_xdr_argument = (xdrproc_t) xdr_twoArgs;
		_xdr_result = (xdrproc_t) xdr_twoArgs;
		local = (char *(*)(char *, struct svc_req *)) nullremote3_1_svc;
		break;

	case nullRemote4:
		_xdr_argument = (xdrproc_t) xdr_tenArgs;
		_xdr_result = (xdrproc_t) xdr_tenArgs;
		local = (char *(*)(char *, struct svc_req *)) nullremote4_1_svc;
		break;

	case nullRemote5:
		_xdr_argument = (xdrproc_t) xdr_arrayArg;
		_xdr_result = (xdrproc_t) xdr_arrayArg;
		local = (char *(*)(char *, struct svc_req *)) nullremote5_1_svc;
		break;
