...
// This function performs sequential search of the list for the user's entry
...
{
	int position = -1, index = 0; // The position is initialized to -1
				      // and will determine when the target
